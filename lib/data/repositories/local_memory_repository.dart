...
class LocalMemoryRepository implements MemoryRepository {
  ...
  Future<Memory?> getMemoryById(String id) async {
    return _database.getMemoryById(id);
  }

  @override
  Future<List<Memory>> getRecentlyRemembered() async {
    return _database.getRecentMemories(limit: 6);
  }

  @override
  Future<List<Memory>> getAttentionItems() async {
    return _database.getAttentionMemories();
  }

  @override
  Future<List<Memory>> getUpcomingItems() async {
    return _database.getUpcomingMemories();
  }

  @override
  Future<List<Memory>> getAllMemories() async {
    return _database.getAllMemories();
  }
  ...
  Future<List<VaultCategory>> getVaultCategories() async {
    ...
    final updatedCategories = defaultVaultCategories.map((cat) {
  ...
  Future<List<Memory>> searchMemories(String query) async {
    ...
    return _database.searchMemories(q);
  }
